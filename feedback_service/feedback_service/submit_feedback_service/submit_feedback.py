...
ORDER_SERVICE_URL = "http://host.docker.internal:5001/order"  # Change localhost to order_service
FEEDBACK_SERVICE_URL = "http://host.docker.internal:5003/feedback"  # Change localhost to feedback_service

@app.route("/submit_feedback", methods=["OPTIONS"])
def handle_options():
