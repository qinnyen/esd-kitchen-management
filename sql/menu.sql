...
('Chicken Wings', 'Crispy fried chicken wings with dipping sauce', 12, TRUE),
('Caesar Salad', 'Romaine lettuce with Caesar dressing and croutons', 9.5, TRUE),
('BBQ Ribs', 'Tender ribs with smoky barbecue sauce', 18, TRUE),
('Fish and Chips', 'Golden fried fish with crispy chips', 14, TRUE),
('Chocolate Cake', 'Rich chocolate cake with ganache topping', 6.5, TRUE);
